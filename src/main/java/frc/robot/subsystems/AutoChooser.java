...
public class AutoChooser extends VirtualSubsystem {
	...
	public AutoChooser() {
		...
		main.add("Number of Pieces", driveOut).withWidget(BuiltInWidgets.kComboBoxChooser).withSize(2, 1)
				.withPosition(3, 1);
	...
	public void periodic() {
		...
		// autoName.setString(
		// allAutos.containsKey(getAutoCommandName()) ? getAutoCommandName() : "Auto
	...
	public String getAutoCommandName() {
		return "Do Nothing";
		// if (pieceNumber.getSelected().equals("Do Nothing")) {
		// return "Do Nothing";
		// } else if (otherStuff.getSelected().equals("Test")) {
		// return "Test";
		// } else {
		// return pieceNumber.getSelected() + " " + otherStuff.getSelected() +
		// sideOfField.getSelected();
		// }
	}
